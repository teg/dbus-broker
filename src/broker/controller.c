...
/**
 * controller_listener_reset_policy() - XXX
 */
int controller_listener_reset_policy(ControllerListener *listener, PolicyRegistry *policy) {
        return error_fold(listener_reset_policy(&listener->listener, policy));
}
